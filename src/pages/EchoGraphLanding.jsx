  ...
  const features = [
    {
      ...
      desc: "Retrieve memories by meaning instead of keywords using vector embeddings.",
    },
    {
      icon: <Search size={28} />,
      title: "Adaptive Ranking",
      desc: "Memories evolve dynamically through recency, importance, and usage patterns.",
    },
    {
      icon: <Database size={28} />,
      title: "Vector Infrastructure",
      desc: "Powered by PostgreSQL + pgvector for scalable semantic search.",
    },
    {
      icon: <Network size={28} />,
      title: "Memory Lifecycle",
      desc: "Manage memory states, reinforcement, expiration, and contextual evolution.",
    },
  ];
